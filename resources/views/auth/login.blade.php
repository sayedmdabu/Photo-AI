      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center">
          <div class="flex-row text-center mx-auto">
            <img
              src="{{asset('assets/img/pages/login-dark.png')}}"
          ...
          <div class="w-px-400 mx-auto">
            ...
            <div class="app-brand mb-4">
              <a href="/" class="app-brand-link gap-2 mb-2">
                ...
                <img alt="image" width="30%" src="{{asset('assets/image/logo/Intelcaffe-logo.png')}}" class="header-logo" />
                <span class="app-brand-text demo h3 mb-0 fw-bold">Photo AI</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Photo AI! 👋</h4>
